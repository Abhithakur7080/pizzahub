...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/update-carts", pizza).then(function (res) {
...
socket.on("orderUpdated", function (data) {
  ...
  updatedOrder.updatedOrder = moment__WEBPACK_IMPORTED_MODULE_1__().format('hh:mm A');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizzahub"] = self["webpackChunkpizzahub"] || [];
